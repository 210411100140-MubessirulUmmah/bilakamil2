            ...
            <div className="flex lg:flex-row flex-col justify-evenly items-center md:gap-32 gap-12 z-10">
                <div className="text-center text-primary">
                    ...
                    >
                        ...
                        <Image
                            src={'/assets/img/IMG_20250612_085352.jpg'}
                            alt="kamil"
                            width={1000}
                            height={1000}
                ...
                <motion.div
                    ...
                    variants={{ hidden: { opacity: 0, y: 100 }, visible: { opacity: 1, y: 0 } }}
                >
                    <Image src={'/assets/img/and.png'} alt="Bila & Kamil" width={1000} height={1000} className="md:w-40 w-20" />
                </motion.div>
                <div className="text-center text-primary">
                    <motion.div
                        initial="hidden"
                    ...
                    >
                        ...
                        />
                        <Image
                            src={'/assets/img/IMG_20250612_085324.jpg'}
                            alt="bila"
                            width={1000}
                            height={1000}
                            className="rounded-t-full border-8 border-primary"
